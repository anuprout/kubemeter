package com.wba.jmeteronkube.controller;
...
import com.wba.jmeteronkube.dao.TestExecutionRepository;
    ...
    public String showHomePage(ModelMap model){
	 ...
	 public ResponseEntity<Object> downloadTestResult(
		 ...
		 try {
			 ...
			 return new ResponseEntity<Object>(jmeterClusterService.zipTestResultsFromPods(testId),httpHeaders,HttpStatus.OK);
